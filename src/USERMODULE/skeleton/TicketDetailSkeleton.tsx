  ...
  <div className="flex w-full justify-center items-center ">
    ...
    <div className="flex-1 flex flex-col p-8 animate-pulse">
      ...
      <div className="space-y-6 flex-1">
        <div className="bg-white rounded shadow p-6 border border-gray-100 flex flex-col gap-2">
    ...
    <div className="w-80 min-w-[300px] border-l bg-gray-50 flex flex-col  p-4 animate-pulse">
