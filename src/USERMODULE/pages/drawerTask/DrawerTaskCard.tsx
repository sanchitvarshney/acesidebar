...
import { getStatusColor } from "../task/utils/taskUtils";
...
const DrawerTaskCard: React.FC<TaskCardProps> = memo(
  ({
    task,
    isSelected,
    isCurrentTask,
...
DrawerTaskCard.displayName = "DrawerTaskCard";

export default DrawerTaskCard;