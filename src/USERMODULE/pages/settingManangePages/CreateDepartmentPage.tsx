...
const CreateDepartmentPage = () => {
    ...
    const [departmentMembers, setDepartmentMembers] = useState([
        { id: 1, name: 'John Doe', email: 'john.doe@company.com', role: 'Agent', status: 'Active' },
        { id: 2, name: 'Jane Smith', email: 'jane.smith@company.com', role: 'Senior Agent', status: 'Active' },
        { id: 3, name: 'Mike Johnson', email: 'mike.johnson@company.com', role: 'Agent', status: 'Inactive' },
    ]);
    ...
    return (
        <Box sx={{
            ...
            <Box sx={{ borderBottom: '1px solid #e0e0e0', bgcolor: '#fff' }}>
                <Typography variant="h4" sx={{ p: 2, fontWeight: 600, color: '#1a1a1a' }}>
                    Create Department
            ...
            {/* Main Content */}
            <Box sx={{ p: 3, display: 'flex', flexDirection: 'column', gap: 2, backgroundColor: '#fff' }}>
                                ...
                                <Step key={step.label}>
                                    ...
                                    >
                                        <Box>
                                            ...
                                            <Typography variant="body2" sx={{ color: '#65676b', mt: 0.5 }}>
                                                {step.description}
                                            </Typography>
                                        </Box>
                                    </StepLabel>
                                                ...
                                                <Box sx={{ maxWidth: 600 }}>
                                                    ...
                                                    <Box sx={{ mb: 3 }}>
                                                        <FormControl component="fieldset">
                                                            ...
                                                            >
                                                                ...
                                                                <FormControlLabel value="Private" control={<Radio />} label="Private (Internal)" />
                                                            </RadioGroup>
                                                        </FormControl>
                                                    </Box>
                                                    ...
                                                    <Box sx={{ mb: 3 }}>
                                                        <FormControl fullWidth>
                                                            <InputLabel>SAL (Service Level Agreement)</InputLabel>
                                                            <Select
                                                                value={formData.sal}
                                                                onChange={(e) => handleInputChange('sal', e.target.value)}
                                                                label="SAL (Service Level Agreement)"
                                                            >
                                                                <MenuItem value="basic">Basic (24 hours)</MenuItem>
                                                                <MenuItem value="standard">Standard (8 hours)</MenuItem>
                                                                <MenuItem value="premium">Premium (4 hours)</MenuItem>
                                                                <MenuItem value="critical">Critical (1 hour)</MenuItem>
                                                            </Select>
                                                        </FormControl>
                                                    </Box>
                                                    ...
                                                    <Box sx={{ mb: 3 }}>
                                                        <FormControl fullWidth>
                                                            ...
                                                            >
                                                                ...
                                                                <MenuItem value="business">Business Hours (9 AM - 6 PM)</MenuItem>
                                                                <MenuItem value="extended">Extended Hours (8 AM - 8 PM)</MenuItem>
                                                    ...
                                                    <Box sx={{ mb: 3 }}>
                                                        <FormControl fullWidth>
                                                            ...
                                                            >
                                                                ...
                                                                <MenuItem value="Department Member">Department Member</MenuItem>
                                                        ...
                                                        <FormControlLabel
                                                            control={
                                                                <Checkbox
                                                                    ...
                                                                    onChange={(e) => handleInputChange('reopenAutoAssignment', e.target.checked)}
                                                                />
                                                            }
                                                    ...
                                                    <Box sx={{ mb: 3 }}>
                                                        <FormControl fullWidth>
                                                            ...
                                                            <Select
                                                                ...
                                                                onChange={(e) => handleInputChange('outgoingEmail', e.target.value)}
                                                                label="Outgoing Email"
                                                            >
                                                                <MenuItem value="support@company.com">support@company.com</MenuItem>
                                                                <MenuItem value="sales@company.com">sales@company.com</MenuItem>
                                                                <MenuItem value="technical@company.com">technical@company.com</MenuItem>
                                                        ...
                                                        <FormControlLabel
                                                            control={
                                                                <Checkbox
                                                                    ...
                                                                    onChange={(e) => handleInputChange('disableNewTicket', e.target.checked)}
                                                                />
                                                            }
                                                        ...
                                                        <FormControlLabel
                                                            control={
                                                                <Checkbox
                                                                    ...
                                                                    onChange={(e) => handleInputChange('disableNewMessage', e.target.checked)}
                                                                />
                                                            }
                                                    ...
                                                    <Box sx={{ mb: 3 }}>
                                                        <FormControl fullWidth>
                                                            ...
                                                            <Select
                                                                ...
                                                                onChange={(e) => handleInputChange('autoResponseEmail', e.target.value)}
                                                                label="Auto-Response Email"
                                                            >
                                                                <MenuItem value="auto-support@company.com">auto-support@company.com</MenuItem>
                                                                <MenuItem value="auto-sales@company.com">auto-sales@company.com</MenuItem>
                                                                <MenuItem value="noreply@company.com">noreply@company.com</MenuItem>
                                                            </Select>
                                                        </FormControl>
                                                    </Box>
                                                    ...
                                                    <Box sx={{ mb: 3 }}>
                                                        <FormControl fullWidth>
                                                            ...
                                                            >
                                                                ...
                                                                <MenuItem value="all-members">All Department Members</MenuItem>
                                                                <MenuItem value="senior-agents">Senior Agents Only</MenuItem>
                                            ...
                                            {index === 2 && (
                                                <Box sx={{ maxWidth: 600 }}>
                                                    ...
                                                    <Box sx={{ mb: 3 }}>
                                                        ...
                                                        />
                                                        <Typography variant="caption" sx={{ color: '#65676b', ml: 4, display: 'block' }}>
                                            ...
                                            <Box sx={{ mb: 2, mt: 3 }}>
                                                <div>
                                                    <Button
                                                        ...
                                                        sx={{ mt: 1, mr: 1 }}
                                                    >
                                                        {index === steps.length - 1 ? 'Save Department' : 'Continue'}
                                                    </Button>
                                                    <Button
                                                        disabled={index === 0}
                                                        onClick={handleBack}
