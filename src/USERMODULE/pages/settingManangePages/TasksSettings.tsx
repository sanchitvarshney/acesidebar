...
const TasksSettings: React.FC = () => {
  ...
  const [newActivityAlertStatus, setNewActivityAlertStatus] =
    useState("disable");
  const [taskAssignmentAlertStatus, setTaskAssignmentAlertStatus] =
    useState("disable");
  const [taskTransferAlertStatus, setTaskTransferAlertStatus] =
    useState("disable");
  const [overdueTaskAlertStatus, setOverdueTaskAlertStatus] =
    useState("disable");
    ...
    >
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          <IconButton onClick={() => navigate("/settings/tasks-knowledge")}>
            <ArrowBackIcon />
          </IconButton>
            ...
            <Grid size={{ xs: 12 }}>
              <Card>
                <CardContent>
                  <Typography
                    variant="h6"
                    sx={{ fontWeight: 600, mb: 3, fontStyle: "italic" }}
                  >
                  ...
                  >
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        e.g.{" "}
                        {taskNumberFormat
                          ? generateTaskNumberPreview(taskNumberFormat)
                          : "401910"}
                      </Typography>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                      <Typography
                        variant="body1"
                        sx={{ minWidth: 214, fontWeight: 600 }}
                      >
                        Default Priority:
                      </Typography>
                      ...
                      <FormControlLabel
                        control={
                          <Switch
                            ...
                            onChange={(e) =>
                              setNewTaskRecipients((prev) => ({
                                ...prev,
                                adminEmail: e.target.checked,
                              }))
                            }
                          />
                        }
                        ...
                        control={
                          <Switch
                            ...
                            onChange={(e) =>
                              setNewTaskRecipients((prev) => ({
                                ...prev,
                                departmentMembers: e.target.checked,
                              }))
                            }
                          />
                        }
                      ...
                      <FormControlLabel
                        control={
                          <Switch
                            ...
                            onChange={(e) =>
                              setNewActivityRecipients((prev) => ({
                                ...prev,
                                lastRespondent: e.target.checked,
                              }))
                            }
                          />
                        }
                        ...
                        control={
                          <Switch
                            ...
                            onChange={(e) =>
                              setNewActivityRecipients((prev) => ({
                                ...prev,
                                assignedAgent: e.target.checked,
                              }))
                            }
                          />
                        }
                      ...
                      <FormControlLabel
                        control={
                          <Switch
                            ...
                            onChange={(e) =>
                              setTaskAssignmentRecipients((prev) => ({
                                ...prev,
                                assignedAgent: e.target.checked,
                              }))
                            }
                      ...
                      <FormControlLabel
                        control={
                          <Switch
                            ...
                            onChange={(e) =>
                              setTaskTransferRecipients((prev) => ({
                                ...prev,
                                assignedAgent: e.target.checked,
                              }))
                            }
