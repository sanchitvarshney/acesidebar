          ...
          <CardContent>
            ...
            <TableContainer>
              <Table stickyHeader>
                ...
                <TableBody>
                  {(["Urgent", "High", "Medium", "Low"] as PriorityKey[]).map(
                    (p) => (
                      <TableRow key={p}>
                        <TableCell>
                          <Stack
                        ...
                        <TableCell>
                          <TextField
                            size="small"
                            value={currentTargets[p].firstResponse}
                            onChange={(e) =>
                              updateTarget(p, { firstResponse: e.target.value })
                            }
                          />
                        </TableCell>
                        <TableCell>
                          <TextField
                            size="small"
                            value={currentTargets[p].resolution}
                            onChange={(e) =>
                              updateTarget(p, { resolution: e.target.value })
                            }
                          />
                        </TableCell>
                        <TableCell>
                          <TextField
                            select
                            size="small"
                            value={currentTargets[p].operationalHours}
                            onChange={(e) =>
                              updateTarget(p, {
                                operationalHours: e.target.value as any,
                              })
                            }
                          >
                        ...
                        <TableCell>
                          <FormControlLabel
                            control={
                              <Switch
                                checked={currentTargets[p].escalation}
                                onChange={(e) =>
                                  updateTarget(p, {
                            ...
                            label={currentTargets[p].escalation ? "On" : "Off"}
                          />
                        </TableCell>
                      </TableRow>
                    )
