...
const KnowledgeBaseSettingsDrawer: React.FC<
  KnowledgeBaseSettingsDrawerProps
> = ({ open, onClose, onSave }) => {
  ...
  return (
    ...
    >
      <Box sx={{ height: "100%", display: "flex", flexDirection: "column" }}>
                    ...
                    control={
                      <Switch
                        ...
                        onChange={(e) =>
                          setSettings((prev) => ({
                            ...prev,
                            requireClientLogin: e.target.checked,
                          }))
                        }
                      />
                    }
                  ...
                  control={
                    <Switch
                      ...
                      onChange={(e) =>
                        setSettings((prev) => ({
                          ...prev,
                          enableCannedResponses: e.target.checked,
                        }))
                      }
                    />
                  }
        ...
        <div className="p-3">
          <CustomAlert title="Disabling knowledge base disables clients' interface." />
        </div>
