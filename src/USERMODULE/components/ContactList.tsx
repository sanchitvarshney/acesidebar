...
const ContactList = () => {
  ...
  const openFilterDialog = useCallback((field: string, label: string) => {
  ...
  }, [selectedFilterField, checkboxValues, filterValue, selectedOperator, activeFilters]);
    ...
    <>
      ...
      <Box
        sx={{
          ...
          borderRadius: 1,
          flexShrink: 0,
          width: columnOrganizerOpen ? { xs: "0%", sm: "60%", md: "70%" } : "100%",
      ...
      >
        ...
        <Box
          sx={{
            ...
            flexDirection: "column",
            backgroundColor: "#fff",
            transform: columnOrganizerOpen ? "translateX(0)" : "translateX(100%)",
