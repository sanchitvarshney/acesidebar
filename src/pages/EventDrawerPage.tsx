...
const EventDrawerPage: React.FC<EventDrawerPageProps> = ({ open, onClose }) => {
  ...
  const [meetingVisibility, setMeetingVisibility] = React.useState<
    "public" | "private"
  >("public");
                        ...
                        <Chip
                          ...
                          sx={{
                            ...
                            borderLeft: `3px solid ${
                              categoryAccentMap[event.category]
                            }`,
                          }}
                        />
                      ))
          ...
          >
            ...
            >
              <Select
                ...
                displayEmpty
                renderValue={(value) =>
                  layoutOptions.find((option) => option.value === value)
                    ?.label ?? "Month"
                }
                MenuProps={{
                  disablePortal: false,
