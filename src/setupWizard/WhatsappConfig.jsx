...
const WhatsappConfig = ({ onNext, onBack, isFirstStep, isLastStep }) => {
  ...
  const handleTestConnection = () => {
    ...
    alert('Testing WhatsApp Business API connection... (This would be implemented with actual API call)');
  };
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-4">WhatsApp Business Integration</h1>
        <p className="text-lg text-gray-600">
          Configure WhatsApp Business API to enable customer support via WhatsApp messaging.
        </p>
      </motion.div>
      ...
      >
        <div className="flex items-start">
          ...
          <div>
            <h3 className="text-lg font-semibold text-blue-800 mb-2">WhatsApp Business API Setup</h3>
