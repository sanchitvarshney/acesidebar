      ...
      <div className="w-full flex flex-col  overflow-hidden ">
        ...
        <div
          style={{
            ...
            height: currentStep === steps.length-1 ? "calc(100vh - 80px)" : "calc(100vh - 180px)",
          }}
        >
          <div className="w-full h-[calc(100vh-185px)] overflow-y-auto  p-3 ">
            <CurrentComponent
              onNext={handleNext}
              onBack={handleBack}
              onSkip={handleSkip}
                  ...
                  <>
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-green-700">
                        Customize your brand identity. Upload your logo and set
                        your brand colors to match your company's style.
                      </p>
                    </div>
                  ...
                  <>
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-yellow-700">
                        Add Google reCAPTCHA to protect your forms from spam and
                        automated attacks.
                      </p>
                    </div>
                ...
                {currentStep === 5 && (
                  <>
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-green-700">
                        Congratulations! Your ticket management system is ready.
                        You can now invite agents and start managing tickets.
                      </p>
                    </div>
